...
(function ($) {
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="jconfirm-scrollpane"><div class=""><div class="jconfirm-box-container"><div class="jconfirm-box" role="dialog" aria-labelledby="labelled" tabindex="-1"><div class="closeIcon">&times;</div><div class="title-c"><span class="icon-c"></span><span class="title"></span></div><div class="content-pane"><div class="content"></div></div><div class="buttons"></div><div class="jquery-clear"></div></div></div></div></div></div>',
        title: '提示',
        ...
        confirmButton: '确 定',
        cancelButton: '关 闭',
        confirmButtonClass: 'am-btn am-btn-primary',
        cancelButtonClass: 'am-btn am-btn-warning',
        theme: 'white',
        animation: 'zoom',
        ...
        watchInterval: 100,
        columnClass: 'am-u-sm-centered am-u-md-4 am-u-sm-6',
        onOpen: function () {
        },
        onClose: function () {
        },
